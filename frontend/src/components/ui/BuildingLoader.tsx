...
export function BuildingLoader() {
  return (
    <div className="w-44 rounded-lg border border-stone-200 bg-white p-3 shadow-sm" aria-hidden="true">
      ...
      <div className="mt-2.5 space-y-1.5">
        {FIELD_DELAYS.map((delay) => (
          <div key={delay} className="h-1.5 w-full overflow-hidden rounded-full bg-stone-100">
            <div
